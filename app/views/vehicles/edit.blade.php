@extends('layouts.master') @section('title') @parent :: {{ Lang::get('gui.vehicles') }} :: {{ $vehicle->licenceplate }} @stop
...
<div class="panel panel-default">
	...
	<div class="panel-body">
			{{ Form::model($vehicle, array('route'=>array('vehicles.update', $vehicle->id),'method'=>'PUT','class'=>'form-horizontal form-group-sm','role'=>'form','id'=>'updateform'))
		}}
		{{ Form::hidden('transporter_fk',$vehicle->transporter->id) }}
		<!-- 	render subview form -->
...
function handleResponse(result){
    ...
    if (result.errorMsg){
    	...
    	bootbox.alert(result.status+"<br>"+result.msg, function(){
    		var pagehref = '{{{ URL::action('VehiclesController@indexAll',array('transporter_fk'=>$vehicle->transporter->id)) }}}';
