...
@section('content')
  ...
  {{ Lang::get('gui.buyers') }} &nbsp;&nbsp;&nbsp;<a
		href="{{{ URL::to('/buyers/create') }}}" role="button"
...
<script>
	$(function(){
	                var grid=$("#grid-data-api").bootgrid({
	                    ...
	                    url: '{{{ URL::action('BuyersController@indexAll') }}}',
	            		formatters: {
	                    ...
	                    {
	                        var pagehref = '/buyers/'+$(this).data("row-id")+'/edit';
	                    ...
	                    }).end().find(".command-delete").on("click", function(e)
	                    {
	                        ...
	                        if (result) {
	                        	...
	                        	$.post('/buyers/'+target,{id:target, _method:'DELETE',_token:'<?=csrf_token(); ?>'},function(result){
	                                if (result.success){
