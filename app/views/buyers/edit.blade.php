@extends('layouts.master') @section('title') @parent :: {{ Lang::get('gui.buyers') }} :: {{ $buyer->cname }} @stop

@section('content')
<h2><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> {{ Lang::get('gui.buyers') }} </h2>
...
<div class="panel panel-default">
	...
	<div class="panel-body">
			{{ Form::model($buyer,
		array('route'=>array('buyers.update', $buyer->id),'method'=>'PUT','class'=>'form-horizontal form-group-sm','role'=>'form','id'=>'updateform'))
		}}
<!-- 	render subview form -->
